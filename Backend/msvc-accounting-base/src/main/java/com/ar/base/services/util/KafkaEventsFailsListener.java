...
@Component
@Slf4j
public class KafkaEventsFailsListener implements iEventListenerService {
    ...
    public void recibirDLTComprobante(String payload,
        ...
        log.info("FALLO EN EL TOPIC DE COMPROBANTES: {} {} {}", payload, topic, key);
    ...
    public void recibirDLTRecibo(String payload,
            @Header(KafkaHeaders.RECEIVED_TOPIC) String topic,
            @Header(KafkaHeaders.RECEIVED_KEY) String key) {
        log.info("FALLO EN EL TOPIC DE RECIBO: {} {} {}", payload, topic, key);
        handleEvents.recibirDLT(payload, topic, key);
    }
    ...
    public void recibirDLTFacturaProveedor(String payload,
            @Header(KafkaHeaders.RECEIVED_TOPIC) String topic,
            @Header(KafkaHeaders.RECEIVED_KEY) String key) {
        log.info("FALLO EN EL TOPIC DE FACTURA DE PROVEEDOR: {} {} {}", payload, topic, key);
        handleEvents.recibirDLT(payload, topic, key);
    }
    ...
    public void recibirDLTMinuta(String payload,
            @Header(KafkaHeaders.RECEIVED_TOPIC) String topic,
            @Header(KafkaHeaders.RECEIVED_KEY) String key) {
        log.info("FALLO EN EL TOPIC DE MINUTA DE PAGO: {} {} {}", payload, topic, key);
        handleEvents.recibirDLT(payload, topic, key);
    }
}
